...
public class GamePanel extends JPanel implements PlayerListener{
	...
	public void nameChanged(Player p) {
		playerLabel.setText("玩家:"+player.getName()+" (LV:"+player.getLV()+")");
	}
	@Override
	...
	public void atkChanged(Player p) {
		ATKLabel.setText("攻击力:"+player.getATK());
	}
	@Override
	public void defChanged(Player p) {
		DEFLabel.setText("防御力:"+player.getDEF());
	}
	@Override
	public void moneyChanged(Player p) {
		moneyLabel.setText("金钱:"+player.getMoney());
	}
	@Override
	public void expChanged(Player p) {
		EXPLabel.setText("经验:"+player.getEXP());
	}
	@Override
	public void keyChanged(Player p) {
		yellowKeyLabel.setText("黄钥匙:"+player.getYellowkey());
		blueKeyLabel.setText("蓝钥匙:"+player.getBluekey());
		redKeyLabel.setText("红钥匙:"+player.getRedkey());
	}
	@Override
